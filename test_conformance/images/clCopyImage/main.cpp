...
test_definition test_list[] = {
    ...
    ADD_TEST( 2Dto3D ),
    ADD_TEST( 3Dto2D ),
    ADD_TEST_VERSION( 2Darrayto2D, Version(1, 2) ),
    ADD_TEST_VERSION( 2Dto2Darray, Version(1, 2) ),
    ADD_TEST_VERSION( 2Darrayto3D, Version(1, 2) ),
    ADD_TEST_VERSION( 3Dto2Darray, Version(1, 2) ),
};
