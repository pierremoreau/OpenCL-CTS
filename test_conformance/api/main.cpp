...
test_definition test_list[] = {
    ...
    ADD_TEST_VERSION(get_program_info_kernel_names, Version(1, 2)),
    ADD_TEST_VERSION(get_kernel_arg_info, Version(1, 2)),
    ...
    ADD_TEST_VERSION(min_max_image_array_size, Version(1, 2)),
    ADD_TEST_VERSION(min_max_image_buffer_size, Version(1, 2)),
    ...
    ADD_TEST_VERSION(get_image1d_info, Version(1, 2)),
    ADD_TEST_VERSION(get_image1d_array_info, Version(1, 2)),
    ADD_TEST_VERSION(get_image2d_array_info, Version(1, 2)),
